...
> = {
  ...
  rack: { position: [4.65, 3.9, 5.9], target: [1.25, 1.65, 0.62] },
  workstation: { position: [6.72, 3.42, 5.36], target: [3.72, 1.84, 0.48] },
  nas: { position: [0.9, 3.3, 5.2], target: [-0.72, 2.18, 1.78] },
  "network-switch": { position: [0.9, 3.9, 5.2], target: [-0.72, 2.9, 1.78] },
  monitor: { position: [5.1, 3.02, 4.95], target: [2.2, 2.42, 1.42] },
  keyboard: { position: [5.02, 2.48, 4.72], target: [2.35, 1.9, 1.52] },
  mouse: { position: [5.02, 2.42, 4.7], target: [2.5, 1.85, 1.56] },
  "external-ssd": { position: [5.02, 2.46, 4.68], target: [2.58, 1.88, 1.52] },
